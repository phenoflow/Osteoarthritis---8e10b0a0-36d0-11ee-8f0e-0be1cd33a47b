...
steps:
  ...
  osteoarthritis-excl-spine-arthrosis---primary:
    run: osteoarthritis-excl-spine-arthrosis---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  osteoarthritis-excl-spine-gonarthrosis---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: osteoarthritis-excl-spine-arthrosis---primary/output
  ...
  osteoarthritis-excl-spine-arthrosis---secondary:
    run: osteoarthritis-excl-spine-arthrosis---secondary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  output-cases:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: osteoarthritis-excl-spine-arthrosis---secondary/output
class: Workflow
inputs:
  potentialCases:
    id: potentialCases
